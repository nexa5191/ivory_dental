...
interface ProviderDef {
  ...
  accent: string; // hsl or hex for the brand tile
...
const PROVIDERS: ProviderDef[] = [
  {
    ...
    Icon: Cloud,
    accent: "#0078D4",
    account: "ivory.admin@ivorydental.in",
    sources: [
  ...
  },
  {
    ...
    Icon: HardDrive,
    accent: "#1A73E8",
    account: "records@ivorydental.in",
...
const FILES: Record<string, MockFile[]> = {
  onedrive: [
    { name: "Patient Records", kind: "folder", modified: "2 days ago" },
    { name: "Consent Forms", kind: "folder", modified: "1 week ago" },
    { name: "Treatment Plan – Rohan Sharma.pdf", kind: "pdf", size: "412 KB", modified: "Yesterday" },
    { name: "Clinic Policy 2026.docx", kind: "doc", size: "88 KB", modified: "3 weeks ago" },
  ],
  sharepoint: [
    { name: "Compliance", kind: "folder", modified: "5 days ago" },
    { name: "Staff Roster.xlsx", kind: "sheet", size: "54 KB", modified: "Today" },
    { name: "Sterilization Log Q2.xlsx", kind: "sheet", size: "120 KB", modified: "2 days ago" },
    { name: "Branch SOP.pdf", kind: "pdf", size: "1.2 MB", modified: "1 month ago" },
  ],
  gdrive: [
    { name: "Radiographs", kind: "folder", modified: "Today" },
    { name: "Invoices", kind: "folder", modified: "4 days ago" },
    { name: "OPG – Priya Nair.png", kind: "image", size: "2.1 MB", modified: "Yesterday" },
    { name: "Lab Bills June.xlsx", kind: "sheet", size: "37 KB", modified: "6 days ago" },
    { name: "Referral Letter.pdf", kind: "pdf", size: "210 KB", modified: "2 weeks ago" },
  ],
  dropbox: [
    { name: "Marketing", kind: "folder", modified: "1 week ago" },
    { name: "Before-After", kind: "folder", modified: "3 days ago" },
    { name: "Clinic Brochure.pdf", kind: "pdf", size: "3.4 MB", modified: "2 weeks ago" },
    { name: "Logo Pack.zip", kind: "file", size: "5.0 MB", modified: "1 month ago" },
  ],
  s3: [
    { name: "backups", kind: "folder", modified: "Automated" },
    { name: "scanned-charts", kind: "folder", modified: "Today" },
    { name: "ivory-db-2026-06-04.bak", kind: "file", size: "48 MB", modified: "Today" },
    { name: "IOPA-16-pat-1.png", kind: "image", size: "880 KB", modified: "Yesterday" },
  ],
};
...
const STORAGE_KEY = "ivory-integrations";

export function DocumentsClient() {
  const [connected, setConnected] = React.useState<Record<ProviderId, boolean>>({
    microsoft: false,
    google: true, // matches the reference screenshot default
    dropbox: false,
    s3: true,
  });
                ...
                {on ? (
                  <div className="flex gap-2">
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onClick={() => setActive(p.sources[0].key)}
                    >
